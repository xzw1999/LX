            ...
            foreach ($cartInfo as &$item) {
                ...
                if (isset($productInfo['attrInfo']['product_id']) && $item['product_attr_unique']) {
                    ...
                    if ($item['seckill_id'] == 0 && $item['bargain_id'] == 0 && $item['combination_id'] == 0) {
                        $item['truePrice'] = $productServices->setLevelPrice($productInfo['attrInfo']['price'] ?? 0, $uid, true, $discount, $item['productInfo']['attrInfo']['vip_price'], $productInfo['is_vip'] ?? 0, true);
                        $item['vip_truePrice'] = (float)$productServices->setLevelPrice($productInfo['attrInfo']['price'], $uid, false, $discount, $item['productInfo']['attrInfo']['vip_price'], $productInfo['is_vip'] ?? 0, true);
                    } else {
                    ...
                    if ($item['seckill_id'] == 0 && $item['bargain_id'] == 0 && $item['combination_id'] == 0) {
                        $item['truePrice'] = $productServices->setLevelPrice($item['productInfo']['price'] ?? 0, $uid, true, $discount, $item['productInfo']['attrInfo']['vip_price'] ?? 0, $item['productInfo']['is_vip'] ?? 0, true);
                        $item['vip_truePrice'] = (float)$productServices->setLevelPrice($item['productInfo']['price'], $uid, false, $discount, $item['productInfo']['attrInfo']['vip_price'] ?? 0, $item['productInfo']['is_vip'] ?? 0, true);
                    } else {
