<template>
    <Card :bordered="false" dis-hover class="ivu-mt">
        <div class="acea-row row-between-wrapper">
            <div class="header-title mb20">用户概括
                <Poptip word-wrap width="500" trigger="hover"  placement="right-start">
                    <Icon type="ios-information-circle-outline" />
                    <div slot="content">
                        <div>访客数</div>
                        <div>在选定条件下，访问商城页面的去重人数</div><br>
                        <div>浏览量</div>
                        <div>在选定条件下，用户浏览商城页面的次数。每打开一个页面或每刷新一次页面都记录1次</div><br>
                        <div>新增用户数</div>
                        <div>在选定条件下，新注册的用户</div><br>
                        <div>成交用户数</div>
                        <div>在选定条件下，下单并支付成功的用户</div><br>
                        <div>访客-支付转化率</div>
                        <div>在选定条件下，全部成交客户数 / 商城访客数</div><br>
                        <div>激活付费会员数</div>
                        <div>在选定条件下，通过各种方式成为付费会员的用户数</div><br>
                        <div>充值用户数</div>
                        <div>在选定条件下，成功充值的用户</div><br>
                        <div>客单价</div>
                        <div>在选定条件下，用户支付的总金额 / 支付人数</div><br>
                        <div>累积用户数</div>
                        <div>商城的总用户</div><br>
                        <div>累积付费会员数</div>
                        <div>筛选时间截止时，具有商城付费会员身份的用户数</div><br>
                        <div>累积充值用户数</div>
                        <div>筛选时间截止时，商城成功充值过的用户</div><br>
                        <div>累积成交用户数</div>
