<template>
    <Card :bordered="false" dis-hover class="ivu-mt">
        <div class="acea-row row-between-wrapper mb20">
            <div class="header-title">交易概括
                <Poptip word-wrap width="500" trigger="hover"  placement="right-start">
                    <Icon type="ios-information-circle-outline" />
                    <div slot="content">
                        <div>营业额</div>
                        <div>商品支付金额、充值金额、购买付费会员金额、线下收银金额</div><br>
                        <div>交易毛利金额</div>
                        <div>交易毛利金额 = 营业额 - 支出金额</div><br>
                        <div>商品支付金额</div>
                        <div>选定条件下，用户购买商品的实际支付金额，包括微信支付、余额支付、支付宝支付、线下支付金额
                            （拼团商品在成团之后计入，线下支付订单在后台确认支付后计入）</div><br>
                        <div>购买会员金额</div>
                        <div>选定条件下，用户成功购买付费会员的金额</div><br>
                        <div>充值金额</div>
                        <div>选定条件下，用户成功充值的金额</div><br>
                        <div>线下收银金额</div>
                        <div>选定条件下，用户在线下扫码支付的金额</div><br>
                        <div>支出金额</div>
                        <div>余额支付金额、支付佣金金额、商品退款金额</div><br>
                        <div>余额支付金额</div>
                        <div>用户下单时使用余额实际支付的金额</div><br>
                        <div>佣金支付金额</div>
                        <div>后台给推广员支付的推广佣金，以实际支付为准</div><br>
                        <div>商品退款金额</div>
                        <div>用户成功退款的商品金额</div>
                    </div>
                </Poptip>
            ...
            <div class="acea-row">
                <DatePicker :editable="false" :clearable="false" @on-change="onchangeTime" :value="timeVal" format="yyyy/MM/dd"
                            ...
                            style="width: 200px;" class="mr20" :options="options"></DatePicker>
        ...
        methods: {
            ...
            getStatistics() {
                ...
                statisticBottomTradeApi({data: this.dataTime}).then(async res => {
                    ...
                    const incons = ['iconyingyee', 'iconyingyee', 'iconshangpinzhifujine', 'icongoumaihuiyuanjine', 'iconyingyee', 'iconyingyee','iconzhichujine','iconyingyee','iconyingyee','iconyingyee']
