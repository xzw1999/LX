<template>
    <div class="Box">
            ...
            <Row :gutter="24" type="flex">
                ...
                <div>
                    <div v-if="isData">
                        ...
                        <Col span="24">
                            <FormItem label="商品详情：">
                                <vue-ueditor-wrap v-model="formValidate.description"  @beforeInit="addCustomDialog"  :config="myConfig"  style="width: 100%;" class="ueditor"></vue-ueditor-wrap>
                            </FormItem>
                        </Col>
                        <Col span="24">
                            <FormItem >
        ...
        <Modal v-model="modalPic" width="800px" scrollable  footer-hide closable title='上传商品图' :mask-closable="false" :z-index="9999">
