                        ...
                        <Row v-show="current === 1" type="flex">
                            ...
                            <Col span="24">
                                <FormItem label="虚拟成团比例(%)：" prop="virtual">
                                    <div class="acea-row row-middle">
                                        <InputNumber :min="1" placeholder="请输入虚拟成团比例" :precision="0" max="100" min="0" element-id="virtual"  v-model="formValidate.virtual" class="perW10" :formatter="value => `${value}%`" :parser="value => value.replace('%', '')"/>
