<template>
	<view>
		...
		<view id="home" class="home-nav acea-row row-around row-middle" :style="{ top: homeTop + 'rpx' }">
					...
					success() {
						if (arr2[2] == '') {
							...
							that.downloadFilePromotionCode(function(msgPromotionCode) {
								...
								that.$util.PosterCanvas(arr2, that.storeInfo.title, that.storeInfo.price,that.storeInfo.to_price, function(tempFilePath) {
