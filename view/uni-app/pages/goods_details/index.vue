<template>
	<view class="product-con">
					...
					<view class="wrapper">
						<view class="share acea-row row-between row-bottom">
							<view class="money font-color">
								...
								<text class="vip-money" v-if="storeInfo.vip_price && storeInfo.vip_price > 0 && storeInfo.is_vip == 1">￥{{ storeInfo.vip_price }}</text>
								<image v-if="storeInfo.vip_price && storeInfo.vip_price > 0 && storeInfo.is_vip == 1" src="../../static/images/svip.gif"></image>
							</view>
		...
		<view class="footer acea-row row-between-wrapper">
			...
			<navigator hover-class="none" class="item" :url="'/pages/customer_list/chat?productId=' + id">
				<view class="iconfont icon-kefu"></view>
				<view>客服</view>
			</navigator>
